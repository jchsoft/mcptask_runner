...
Pick the first row that matches the query shape:
...
| Unknown / open-ended | `codegraph_search` with best guess, then `codegraph_context` | Grep last resort |
